    ...
    public class AddAseguradoToVehiculoLogicCommand: Command<int>
    {
        ...
        public override void Execute()
        {
            try
            {
                ...
                GetVehiculoByIdCommand selectByIdCommand = VehiculoCommandFactory.createGetVehiculoByIdCommand(_vehiculoId);
                ...
                GetAseguradoByIdCommand getAseguradoCommand = AseguradoCommandFactory.createGetAseguradoByIdCommand(_aseguradoId);
                ...
                AddAseguradoToVehiculoCommand registerCommand = VehiculoCommandFactory.createAddAseguradoToVehiculoCommand(_vehiculoId, _aseguradoId);

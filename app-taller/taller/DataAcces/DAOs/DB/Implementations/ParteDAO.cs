...
namespace taller.DataAcces.DAOs
{
    public class ParteDAO : IParteDAO
    {
        ...
        /// </summary>
        /// <param name="parte">DTO de registro con la informacion del taller</param>
        ...
        public Guid RegisterParte(Parte parte)
        {
            try
            {
                ...
                return parte.parteId;
            }
            catch (Exception ex)
            {
                throw new RCVException("Error al crear la parte", ex);
        ...
        public ICollection<ParteToShowDTO> GetAll()
        {
            ...
            {
                throw new RCVException("Error al obtener las partes", ex);
            }
        }

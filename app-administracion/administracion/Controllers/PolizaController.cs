...
namespace administracion.Controllers
{
    ...
    public class PolizaController: Controller
    {
        ...
        [HttpPost("registrar")]
        public ApplicationResponse<Guid> registrarPoliza([FromBody] PolizaRegisterDTO poliza)
        {
            var response = new ApplicationResponse<Guid>();
            try
            {
                RegisterPolizaLogicCommand command = PolizaCommandFactory
                    .createRegisterPolizaLogicCommand(poliza);

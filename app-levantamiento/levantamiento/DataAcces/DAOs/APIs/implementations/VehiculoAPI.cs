...
namespace levantamiento.DataAccess.APIs
{
    public class VehiculoAPI : IVehiculoAPI
    {
        ...
        public async Task<Guid> RegisterVehiculo(VehiculoRegisterDTO vehiculo)
        {
            ...
            try
            {
                using(var httpClient = new HttpClient())
                {
                    ...
                    if(response.IsSuccessStatusCode)
                    {
                        ...
                        var APIResponse = JsonSerializer.Deserialize<ApplicationResponse<Guid>>(content, options);

...
namespace administracion.Controllers
{
    ...
    public class SolicitudController: Controller
    {
        ...
        [HttpPost("registrar")]
        public ApplicationResponse<bool> RegistrarSolicitud([Required][FromBody] SolicitudRepacionRegisterDTO solicitud)
        {
            var response = new ApplicationResponse<bool>();
            try
            {
                response.Data = _solicitudReparacionLogic.RegisterSolicitud(solicitud);
                response.StatusCode = System.Net.HttpStatusCode.OK;
                response.Success = true;

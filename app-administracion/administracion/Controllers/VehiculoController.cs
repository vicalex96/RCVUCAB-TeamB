...
namespace administracion.Controllers
{
    ...
    public class VehiculoController: Controller
    {
        ...
        public ApplicationResponse<VehiculoDTO> GetVehiculoByGuid([Required][FromRoute] Guid vehiculoId)
        {
            ...
            try
            {
                GetVehiculoByIdCommand command = VehiculoCommandFactory
                    .createGetVehiculoByIdCommand(vehiculoId);
                command.Execute();
        ...
        public ApplicationResponse<Guid> createVehiculo([FromBody] VehiculoRegisterDTO Vehiculo)
        {
            ...
            try
            {
                RegisterVehiculoLogicCommand command = VehiculoCommandFactory.createRegisterVehiculoLogicCommand(Vehiculo);
        ...
        public ApplicationResponse<int> AddAsegurado([Required][FromRoute] Guid vehiculoId ,[Required][FromRoute] Guid aseguradoId)
        {
            ...
            try
            {
                AddAseguradoToVehiculoLogicCommand command = VehiculoCommandFactory
                    .createAddAseguradoToVehiculoLogicCommand(vehiculoId, aseguradoId);
